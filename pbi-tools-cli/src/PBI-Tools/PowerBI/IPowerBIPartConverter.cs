...
{
    /// <summary>
    /// Converts back-and-forth between a Power BI <see cref="IStreamablePowerBIPackagePartContent"/> and a specific representation of the underlying content as <see cref="T"/>.
    /// </summary>
