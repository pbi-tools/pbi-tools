...
namespace PbiTools.Serialization
{
    ...
    public partial class TabularModelSerializer
    {
        ...
        internal TabularModelSerializer(IProjectRootFolder rootFolder, ModelSettings settings, IDictionary<string, string> queries = null)
        {
